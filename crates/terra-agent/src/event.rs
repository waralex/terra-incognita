...
fn handle_key(app: &mut App, key: KeyEvent) -> Option<String> {
    match (key.code, key.modifiers) {
        ...
        (KeyCode::Char('u'), KeyModifiers::CONTROL) | (KeyCode::PageUp, _) => app.panel_up(),
        (KeyCode::Char('d'), KeyModifiers::CONTROL) | (KeyCode::PageDown, _) => app.panel_down(),
        (KeyCode::Char('y'), KeyModifiers::CONTROL) => app.copy_state_to_clipboard(),
